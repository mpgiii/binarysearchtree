...
class MyAsg3Tests(unittest.TestCase):
    def test_binsearchtree_constructor1(self):
        bt1 = BinarySearchTree(contents=[0, 100, -100, -150, -50, 2000])
        bt2 = BinarySearchTree(contents=[0, 100, -100, -150, -50, 2000])
    ...
    def test_binsearchtree_inorder1(self):
        bt = BinarySearchTree(contents=[0, 100, -100, -150, -50, 2000])
        self.assertListEqual(bt.inorder(), [-150, -100, -50, 0, 100, 2000])

    def test_binsearchtree_preorder1(self):
        bt = BinarySearchTree(contents=[0, 100, -100, -150, -50, 2000])
        self.assertListEqual([0, -100, -150, -50, 100, 2000], bt.preorder())

    def test_binsearchtree_postorder1(self):
        bt = BinarySearchTree(contents=[0, 100, -100, -150, -50, 2000])
        self.assertListEqual([-150, -50, -100, 2000, 100, 0], bt.postorder())

    def test_binsearchtree_levelorder1(self):
        bt = BinarySearchTree(contents=[0, 100, -100, -150, -50, 2000])
        self.assertListEqual([0, -100, 100, -150, -50, 2000], bt.levelorder())
